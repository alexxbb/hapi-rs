...
pub const HAPI_CACHE_COP2_COOK: &[u8; 19] = b"Old COP Cook Cache\0";
pub const HAPI_CACHE_COP2_FLIPBOOK: &[u8; 21] = b"Composite View Cache\0";
...
pub const HAPI_VERSION_HOUDINI_MAJOR: u32 = 22;
...
pub const HAPI_VERSION_HOUDINI_ENGINE_MAJOR: u32 = 9;
...
pub enum HapiResult {
    ...
    SharedMemoryBufferOverflow = 170,
    InvalidSharedMemoryBuffer = 180,
    AssetInvalid = 200,
    NodeInvalid = 210,
    UserInterrupted = 300,
    InvalidSession = 400,
...
pub struct HAPI_SessionInfo {
    ...
    pub enableSharedMemoryDataTransfer: HAPI_Bool,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct HAPI_CameraInfo {
    pub focal: f64,
    pub aperture: f64,
    pub pixelAspect: f64,
    pub focusDistance: f64,
    pub fStop: f64,
    pub imagingDistance: f64,
    pub resX: HAPI_Int64,
    pub resY: HAPI_Int64,
    pub cropX: [f64; 2usize],
    pub cropY: [f64; 2usize],
    pub winX: [f64; 2usize],
    pub winY: [f64; 2usize],
    pub clipNear: f64,
    pub clipFar: f64,
    pub shutterOpen: f64,
    pub shutterClose: f64,
    pub orthoZoom: f64,
    pub guideScale: f64,
    pub projection: CameraProjectionType,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
unsafe extern "C" {
    pub fn HAPI_CameraInfo_Init(in_: *mut HAPI_CameraInfo);
}
unsafe extern "C" {
    pub fn HAPI_CameraInfo_Create() -> HAPI_CameraInfo;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn HAPI_GetTime(session: *const HAPI_Session, time: *mut f64) -> HapiResult;
}
unsafe extern "C" {
    pub fn HAPI_SetTime(session: *const HAPI_Session, time: f64) -> HapiResult;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn HAPI_GetCameraInfo(
        session: *const HAPI_Session,
        node_id: HAPI_NodeId,
        part_id: HAPI_PartId,
        camera_info: *mut HAPI_CameraInfo,
    ) -> HapiResult;
}
unsafe extern "C" {
    pub fn HAPI_GetCameraTransform(
        session: *const HAPI_Session,
        node_id: HAPI_NodeId,
        part_id: HAPI_PartId,
        transform: *mut HAPI_Transform,
...
unsafe extern "C" {
    pub fn HAPI_CreateInputCameraNode(
        session: *const HAPI_Session,
        parent_node_id: HAPI_NodeId,
        node_id: *mut HAPI_NodeId,
...
unsafe extern "C" {
    pub fn HAPI_SetInputCameraInfo(
        session: *const HAPI_Session,
        node_id: HAPI_NodeId,
        camera_info: *const HAPI_CameraInfo,
    ) -> HapiResult;
}
unsafe extern "C" {
    pub fn HAPI_SetInputCameraTransform(
        session: *const HAPI_Session,
        node_id: HAPI_NodeId,
        rst_order: RSTOrder,
        rot_order: XYZOrder,
...
unsafe extern "C" {
    pub fn HAPI_SetAttributeIndexedStringData(
        ...
        name: *const ::std::os::raw::c_char,
        attr_info: *const HAPI_AttributeInfo,
        string_fixed_array: *mut *const ::std::os::raw::c_char,
        string_fixed_length: ::std::os::raw::c_int,
...
unsafe extern "C" {
    pub fn HAPI_RenderCOPOutputToImage(
        session: *const HAPI_Session,
        cop_node_id: HAPI_NodeId,
        cop_output_name: *const ::std::os::raw::c_char,
    ) -> HapiResult;
}
unsafe extern "C" {
