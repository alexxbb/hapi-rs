...
pub const HAPI_VERSION_HOUDINI_BUILD: u32 = 597;
pub const HAPI_VERSION_HOUDINI_PATCH: u32 = 0;
pub const HAPI_VERSION_HOUDINI_ENGINE_MAJOR: u32 = 3;
pub const HAPI_VERSION_HOUDINI_ENGINE_MINOR: u32 = 4;
...
impl ErrorCode {
    pub const Found: ErrorCode = ErrorCode(1);
}
impl ErrorCode {
    pub const Error: ErrorCode = ErrorCode(2);
}
...
#[repr(transparent)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub struct ErrorCode(pub ::std::os::raw::c_uint);
...
pub enum PdgEventType {
    ...
    EventWorkitemResult = 27,
    EventWorkitemPriority = 28,
    EventCookStart = 29,
    AddStaticAncestor = 30,
    RemoveStaticAncestor = 31,
    NodeProgressUpdate = 32,
    PdgEventAll = 33,
    PdgEventLog = 34,
    PdgContextEvents = 35,
}
