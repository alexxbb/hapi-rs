...
pub const HAPI_VERSION_HOUDINI_BUILD: u32 = 625;
pub const HAPI_VERSION_HOUDINI_PATCH: u32 = 0;
pub const HAPI_VERSION_HOUDINI_ENGINE_MAJOR: u32 = 6;
...
pub enum PdgEventType {
    ...
    WorkitemSetFile = 25,
    WorkitemSetPyobject = 26,
    WorkitemSetGeometry = 27,
    EventWorkitemMerge = 28,
    EventWorkitemResult = 29,
    EventWorkitemPriority = 30,
    EventCookStart = 31,
    AddStaticAncestor = 32,
    RemoveStaticAncestor = 33,
    NodeProgressUpdate = 34,
    BatchItemInitialized = 35,
    PdgEventAll = 36,
    PdgEventLog = 37,
    EventSchedulerAdded = 38,
    EventSchedulerRemoved = 39,
    EventSetScheduler = 40,
    ServiceManagerAll = 41,
    EventNodeCooked = 42,
    EventNodeGenerated = 43,
    PdgContextEvents = 44,
}
#[repr(i32)]
#[non_exhaustive]
