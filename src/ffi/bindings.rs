...
pub const HAPI_ATTRIB_ROT: &'static [u8; 4usize] = b"rot\0";
pub const HAPI_ATTRIB_SCALE: &'static [u8; 6usize] = b"scale\0";
...
pub const HAPI_ATTRIB_INPUT_CURVE_COORDS: &'static [u8; 24usize] = b"hapi_input_curve_coords\0";
...
pub const HAPI_VERSION_HOUDINI_MINOR: u32 = 0;
pub const HAPI_VERSION_HOUDINI_BUILD: u32 = 455;
pub const HAPI_VERSION_HOUDINI_PATCH: u32 = 0;
pub const HAPI_VERSION_HOUDINI_ENGINE_MAJOR: u32 = 4;
pub const HAPI_VERSION_HOUDINI_ENGINE_MINOR: u32 = 2;
pub const HAPI_VERSION_HOUDINI_ENGINE_API: u32 = 7;
...
impl ErrorCode {
    pub const AssetDefNotFound: ErrorCode = ErrorCode(1);
}
impl ErrorCode {
    pub const PythonNodeError: ErrorCode = ErrorCode(2);
}
impl ::std::ops::BitOr<ErrorCode> for ErrorCode {
    type Output = Self;
    #[inline]
...
impl ::std::ops::BitOrAssign for ErrorCode {
    #[inline]
    fn bitor_assign(&mut self, rhs: ErrorCode) {
        self.0 |= rhs.0;
    }
}
impl ::std::ops::BitAnd<ErrorCode> for ErrorCode {
    type Output = Self;
    #[inline]
...
impl ::std::ops::BitAndAssign for ErrorCode {
    #[inline]
...
#[repr(transparent)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub struct ErrorCode(pub ::std::os::raw::c_int);
...
impl NodeType {
    pub const Any: NodeType = NodeType(-1);
}
impl NodeType {
    pub const None: NodeType = NodeType(0);
}
impl NodeType {
    pub const Obj: NodeType = NodeType(1);
}
impl NodeType {
    pub const Sop: NodeType = NodeType(2);
}
impl NodeType {
    pub const Chop: NodeType = NodeType(4);
}
impl NodeType {
    pub const Rop: NodeType = NodeType(8);
}
impl NodeType {
    pub const Shop: NodeType = NodeType(16);
}
impl NodeType {
    pub const Cop: NodeType = NodeType(32);
}
impl NodeType {
    pub const Vop: NodeType = NodeType(64);
}
impl NodeType {
    pub const Dop: NodeType = NodeType(128);
}
impl NodeType {
    pub const Top: NodeType = NodeType(256);
}
impl ::std::ops::BitOr<NodeType> for NodeType {
    type Output = Self;
    #[inline]
    fn bitor(self, other: Self) -> Self {
...
impl ::std::ops::BitOrAssign for NodeType {
    #[inline]
    fn bitor_assign(&mut self, rhs: NodeType) {
        self.0 |= rhs.0;
    }
}
impl ::std::ops::BitAnd<NodeType> for NodeType {
    type Output = Self;
    #[inline]
    fn bitand(self, other: Self) -> Self {
        NodeType(self.0 & other.0)
...
impl ::std::ops::BitAndAssign for NodeType {
    #[inline]
...
#[repr(transparent)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub struct NodeType(pub ::std::os::raw::c_int);
pub type HAPI_NodeTypeBits = ::std::os::raw::c_int;
impl NodeFlags {
    pub const Any: NodeFlags = NodeFlags(-1);
}
impl NodeFlags {
    pub const None: NodeFlags = NodeFlags(0);
}
impl NodeFlags {
    pub const Display: NodeFlags = NodeFlags(1);
}
impl NodeFlags {
    pub const Render: NodeFlags = NodeFlags(2);
}
impl NodeFlags {
    pub const Templated: NodeFlags = NodeFlags(4);
}
impl NodeFlags {
    pub const Locked: NodeFlags = NodeFlags(8);
}
impl NodeFlags {
    pub const Editable: NodeFlags = NodeFlags(16);
}
impl NodeFlags {
    pub const Bypass: NodeFlags = NodeFlags(32);
}
impl NodeFlags {
    pub const Network: NodeFlags = NodeFlags(64);
}
impl NodeFlags {
    pub const Geometry: NodeFlags = NodeFlags(128);
}
impl NodeFlags {
    pub const Camera: NodeFlags = NodeFlags(256);
}
impl NodeFlags {
    pub const Light: NodeFlags = NodeFlags(512);
}
impl NodeFlags {
    pub const Subnet: NodeFlags = NodeFlags(1024);
}
impl NodeFlags {
    pub const Curve: NodeFlags = NodeFlags(2048);
}
impl NodeFlags {
    pub const Guide: NodeFlags = NodeFlags(4096);
}
impl NodeFlags {
    pub const Nonscheduler: NodeFlags = NodeFlags(8192);
}
impl NodeFlags {
    pub const NonBypass: NodeFlags = NodeFlags(16384);
}
impl ::std::ops::BitOr<NodeFlags> for NodeFlags {
    type Output = Self;
    #[inline]
    fn bitor(self, other: Self) -> Self {
...
impl ::std::ops::BitAnd<NodeFlags> for NodeFlags {
    type Output = Self;
    #[inline]
    fn bitand(self, other: Self) -> Self {
        NodeFlags(self.0 & other.0)
...
#[repr(transparent)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub struct NodeFlags(pub ::std::os::raw::c_int);
